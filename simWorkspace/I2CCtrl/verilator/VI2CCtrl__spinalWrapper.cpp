...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.io_config_frame_addrmode );
      signalAccess[1] = new CDataSignalAccess( top.io_write_valid );
      signalAccess[2] = new CDataSignalAccess( top.io_write_ready );
      signalAccess[3] = new CDataSignalAccess( top.io_write_payload );
      signalAccess[4] = new CDataSignalAccess( top.io_read_valid );
      signalAccess[5] = new CDataSignalAccess( top.io_read_ready );
      signalAccess[6] = new CDataSignalAccess( top.io_read_payload );
      signalAccess[7] = new CDataSignalAccess( top.io_i2c_sda_oe );
      signalAccess[8] = new CDataSignalAccess( top.io_i2c_scl_oe );
      signalAccess[9] = new CDataSignalAccess( top.io_i2c_scl_write );
      signalAccess[10] = new CDataSignalAccess( top.io_i2c_scl_read );
      signalAccess[11] = new CDataSignalAccess( top.io_i2c_sda_write );
      signalAccess[12] = new CDataSignalAccess( top.io_i2c_sda_read );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/jiayizhang/workplace/i2c_lab/./simWorkspace/I2CCtrl/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/jiayizhang/workplace/i2c_lab/./simWorkspace/I2CCtrl/") + name + ".dat").c_str());
      #endif
    }
